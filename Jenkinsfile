node{
    ...
    stage('SCM Checkout'){
        git url: 'https://github.com/devopsdesk/java-web-app-docker.git',branch: 'master'
    }
    ...
    stage('Build Docker Image'){
        sh 'docker build -t devopsdesk/java-web-app .'
    }
    ...
    stage('Push Docker Image'){
        ...
        sh 'docker push devopsdesk/java-web-app'
     }
